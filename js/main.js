...
function heart(){
    ...
    popup = $('<div><img class="popup" src="./img/free-icon-teddy-bear-3769084.png" alt=""><img class="close_popup" src="./img/free-icon-cancel-181661.png" alt=""><p class="popup_text">Happy Valentines day!</p><p class="popup_text2">by AIS</p><p id="poshalka">wsg контора пидорасов </p> </div>');
